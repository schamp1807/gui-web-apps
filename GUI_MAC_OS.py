...
l2=Label(LHS, text=f"System Version : {my_system.version}",bg="#f4f5f5",font=("Acumin Variable Concept",8,'bold'),justify="center")
l2.place(x=20,y=225)

l3=Label(LHS, text=f"system:{my_system.system}",bg="#f4f5f5",font=("Acumin Variable Concept",15,'bold'),justify="center")
l3.place(x=20,y=250)

l4=Label(LHS, text=f"Machine:{my_system.machine}",bg="#f4f5f5",font=("Acumin Variable Concept",14,'bold'),justify="center")
l4.place(x=20,y=285)

l5=Label(LHS, text=f"Total Ram installed:{round(psutil.virtual_memory().total/1000000000,2)}GB",bg="#f4f5f5",font=("Acumin Variable Concept",8,'bold'),justify="center")
l5.place(x=20,y=310)
...
system=Label(RHS,text='system',font=("arial",15),bg="#f4f5f5")
...
def none():
    ...
    lbl.config(text=f"Charging : {percent}%")
    lbl_plug.config(text=f'Plug in:{str(battery.power_plugged)}')
    lbl_time.config(text=f'Time {time} remaining')
...
lbl=Label(RHS,font=("arial",15,'bold'),bg='#f4f5f5')
lbl.place(x=200,y=40)

lbl_plug=Label(RHS,font=("arial",10),bg='#f4f5f5')
lbl_plug.place(x=20,y=100)

lbl_time=Label(RHS,font=("arial",14),bg='#f4f5f5')
...
lbl_speaker=Label(RHS,text="Speaker:",font=('arial',8,'bold'),bg="#f4f5f5")
...
lbl_brightness=Label(RHS,text='Brightness:',font=('arial',8,'bold'),bg="#f4f5f5")
...
def weather():
    ...
    t=Label(app1, font=('arial',7,'bold'), fg="#ee666d", bg='#f4f5f5')
    t.place(x=400, y=150)
...
app10=Button(RHB,image=app10_image,bd=0,command=instagram)
